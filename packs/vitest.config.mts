...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'packs/react-testing-ts/challenges/**/*.test.tsx',
      'packs/react-routing-tanstack-ts/challenges/**/*.test.tsx',
      'packs/react-routing-rr-ts/challenges/**/*.test.tsx',
      'packs/react-state-mgmt-ts/challenges/**/*.test.tsx',
      'packs/react-architecture-ts/challenges/**/*.test.tsx',
    ],
